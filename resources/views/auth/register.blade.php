            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="gender" class="col-md-4 col-form-label text-md-end">{{ __('Fender') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input 
                                    ...
                                    name="hobby" value="{{ old('hobby') }}" required autocomplete="hobby" 
                                    autofocus
                                    placeholder="eg: soccer swimming watch_movie"    
                                >
                        ...
                        <div class="row mb-3">
                            <label for="fee" class="col-md-4 col-form-label text-md-end">{{ __('Register Fee') }}</label>

                            <div class="col-md-6">
                                <input id="fee" 
                                    type="number" class="form-control @error('fee') is-invalid @enderror" 
                                    name="fee" value="{{ old('fee') }}" 
                                    required autocomplete="email"
                                    placeholder="2500 coins"    
                                >
